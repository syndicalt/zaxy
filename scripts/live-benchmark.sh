...
usage() {
    cat <<USAGE
Usage: scripts/live-benchmark.sh [--root PATH] [--output-dir PATH] [--runs N] [--limit N] [--embedding-provider openai|hash] [--embedding-cache PATH] [--progress] [--workload fixture|statistical|frozen|suite|consolidation|source-recall|temporal-recall|longmemeval] [--dataset PATH] [--questions N] [--subjects N] [--documents N] [--sessions N] [--reset-graph]
