...
0.840 versus Zaxy checkout R@5 0.990. The archived full 500-question hash run is
the broader no-regression floor: Zaxy checkout mean score 0.626, Answer@5 0.608,
citation coverage 1.000, and R@5 0.956. External MemPalace, Mem0, and Agent
Memory numbers should be described as external disclosures until those systems
run through the same Zaxy harness.
